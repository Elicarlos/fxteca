...
from django.urls import path
from .views import (
    HomePageView, PostDetailView, AboutPageView, ContactPageView, 
    CategoryPostListView, SearchResultsView, ads_txt, loaderio
)
...
urlpatterns = [
    ...
    path('<slug:slug>/', PostDetailView.as_view(), name='post_detail'),  # Alterado
